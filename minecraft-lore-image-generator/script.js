...
function invalidate() {
    valid = false;
    document.getElementById("customCodeButton").classList.add("disabled");
    document.getElementById("copyButton").classList.add("disabled");
}

function validate() {
    valid = true;
    document.getElementById("customCodeButton").classList.remove("disabled");
